...
class CameraCalibrator:
    ...
    def genCornerCoordinates(self, u_meas, v_meas):
        ...
        x = np.multiply(self.d_square, np.arange(self.n_corners_x))
        print("x",x)

        y=np.multiply(self.d_square, np.arange(self.n_corners_y))
        print("y",y)
...
#        print("V.shape",V.shape)
 ...
 #       print("B11,B12,B22,B13,B23,B33",B11,B12,B22,B13,B23,B33)
        ...
        beta=np.sqrt((lamba*B11)/(B11*B22-B12*B12))
        gamma = -B12*np.square(alpha)*beta/lamba
